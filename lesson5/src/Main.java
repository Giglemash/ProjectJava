public class Main {
    ...
    static class ThreadedArray implements Runnable {
        ...
        public void run() {
            ...
            System.out.println("Время обработки (поток " + threadNum + "): " + timeCalculationArrayFinal + " мс");
        }
    }
    ...
    public static void simpleArray() {
        ...
        System.out.println("Время работы: " + timeSimpleArrayFinal + " мс");
    }
    ...
    private static void dividedArray() {
        ...
        System.out.println("Время разбивки массива на 2: " + timeDivideArrayFinal + " мс");
        ...
        System.out.println("Время склейки: " + timeJoinArrayAfter + " мс");
        System.out.println("Общее время: " + (System.currentTimeMillis() - timeDivideArrayBefore) + " мс");
    }
...
//+ (time* / 1000) + "сек\n"); - для расчета в сек.
// Поменять местами потоки (Доделать).